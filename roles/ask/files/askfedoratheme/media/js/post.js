...
var Vote = function(){
    ...
    var callback_favorite = function(object, voteType, data){
        if(data.allowed == "0" && data.success == "0"){
            ...
            var follow_html = gettext('<button class="normal-btn">Follow</button>');
            ...
            var followed_html = gettext('<div  style="text-align: left; color: #3c6eb4;">Following</div><button class="unfollow normal-btn">Unfollow</button>');
