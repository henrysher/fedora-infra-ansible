...
LABEL Fed23-ppc64le
     ...
     IPAPPEND 2
     APPEND ks initrd=images/Fedora/23/ppc64le/initrd.img method=http://10.5.126.23/pub/fedora-secondary/releases/23/Server/ppc64le/os/ ip=dhcp ksdevice=bootif ks=http://10.5.126.23/repo/rhel/ks/hardware-f23-power8-LE-12disk.cfg net.ifnames=0 biosdevname=0 
