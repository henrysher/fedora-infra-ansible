...
LABEL Fed23-x86_64-nohd
     ...
     APPEND ks initrd=images/Fedora/23/x86_64/initrd.img method=http://10.5.126.23/pub/fedora/linux/releases/23/Server/x86_64/os/ ip=dhcp ks=http://10.5.126.23/repo/rhel/ks/hardware-f23-nohd.cfg net.iframes=0 biosdevname=0 ksdevice=eth0
