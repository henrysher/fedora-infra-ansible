...
LABEL Fed24-taskotron-x86_64
     ...
     KERNEL images/Fedora/24/x86_64/vmlinuz
     APPEND ks initrd=images/Fedora/24/x86_64/initrd.img method=http://10.5.126.23/pub/fedora/linux/releases/24/Server/x86_64/os/ ip=dhcp ks=http://10.5.126.23/repo/rhel/ks/hardware-f24-taskotron.cfg net.ifnames=0 ksdevice=eth0 inst.updates=http://vpodzime.fedorapeople.org/pv_create_sleep_updates.img
