...
LABEL Fed23-x86_64-buildhw
     ...
     KERNEL images/Fedora/23/x86_64/vmlinuz
     APPEND initrd=images/Fedora/23/x86_64/initrd.img repo=http://10.5.126.23/pub/fedora/linux/releases/23/Server/x86_64/os/ ip=eth0:dhcp ks=http://10.5.126.23/repo/rhel/ks/buildhw-fedora-23 text net.ifnames=0 biosdevname=0 ksdevice=etht0
