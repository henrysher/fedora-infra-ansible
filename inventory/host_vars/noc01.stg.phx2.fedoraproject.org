...
management_hosts:
  - apc-rack16-a.mgmt.fedoraproject.org
  - apc-rack16-b.mgmt.fedoraproject.org
  - atomic01.mgmt.fedoraproject.org
  ...
  - cloud-eql02.mgmt.fedoraproject.org
  - cockpit-test.mgmt.fedoraproject.org
  ...
  - junk01.mgmt.fedoraproject.org
  - junk02.mgmt.fedoraproject.org
  ...
  - opengear03.mgmt.fedoraproject.org
  - opengear04.mgmt.fedoraproject.org
  - ppc-build01.mgmt.fedoraproject.org
  - ppc-comm03.mgmt.fedoraproject.org
  - ppc8-01-fsp.mgmt.fedoraproject.org
  - ppc8-02-fsp.mgmt.fedoraproject.org
  - ppc8-03-fsp.mgmt.fedoraproject.org
  - ppc8-04-fsp.mgmt.fedoraproject.org
  ...
  - rack46-serial.mgmt.fedoraproject.org
  ...
  - rack49-serial.mgmt.fedoraproject.org
  - rack50-kvm.mgmt.fedoraproject.org
  - rack50-serial.mgmt.fedoraproject.org
  - rack51-bc02-sw1.mgmt.fedoraproject.org
  - rack51-bc02-sw2.mgmt.fedoraproject.org
  - rack51-serial.mgmt.fedoraproject.org
  - rack52-serial.mgmt.fedoraproject.org
  - rack53-serial.mgmt.fedoraproject.org
  - retrace01.mgmt.fedoraproject.org
  - retrace02.mgmt.fedoraproject.org
  - retrace04.mgmt.fedoraproject.org
  - sign-vault03.mgmt.fedoraproject.org
  - sign-vault04.mgmt.fedoraproject.org
  - tape02.mgmt.fedoraproject.org
  - vhcloud01.mgmt.fedoraproject.org
  - virthost-comm01.mgmt.fedoraproject.org
